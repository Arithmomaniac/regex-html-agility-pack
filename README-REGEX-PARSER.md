...
|-----------|----------------|--------|
| Tokenization | Regex patterns | 100% regex |
| Attribute parsing | Regex patterns | 100% regex |
| Nested tag matching | Balancing groups | 100% regex |
| Tree construction | C# from tokens | Hybrid |
| Malformed HTML handling | HTML5 spec rules | Hybrid |
...
├── HtmlPatterns.cs            # All regex patterns (compiled)
...
- [Mastering Regular Expressions, 3rd Edition](http://regex.info/book.html) — Chapter 9 covers .NET specifics

## License

Same as HtmlAgilityPack (MIT).
